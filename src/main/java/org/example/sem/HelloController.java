...
public class HelloController {
    ...
    private void parseMainWeatherData(String output, String getUserCity) {
        ...
        if (!output.isEmpty()) {
            ...
            clouds.setText((obj.getJSONObject("clouds").getDouble("all")) + "%");
            ...
            try {
                ...
                System.out.println("Ошибка загрузки иконки погоды.");
            }
        }
    }
    ...
    private void setIcon(String iconCode, ImageView imageView) {
        ...
        try {
            ...
            logger.error("Ошибка загрузки иконки погоды: {}", e.getMessage());
        }
    }
}
